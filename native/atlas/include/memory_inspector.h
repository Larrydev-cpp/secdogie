...
struct DibHit {
  ...
  // "heap" (process memory DIB) or "cgwindow" (macOS Screen Recording of the
  // target hwnd). AX/UIA trees have names and bounds, not pixels.
  std::string source;
};
...
// bit_count. Used for macOS CGWindow previews — AX has no pixels.
